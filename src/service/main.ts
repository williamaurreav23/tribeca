...
import Bitforex = require("./gateways/bitforex");
...
const liveTradingSetup = () : SimulationClasses => {
    ...
    const getExchange = (): Models.Exchange => {
        ...
        switch (ex) {
            ...
            case "bitforex": return Models.Exchange.Bitforex;
    ...
    const getExch = (orderCache: Broker.OrderStateCache): Promise<Interfaces.CombinedGateway> => {
        switch (exchange) {
            ...
            case Models.Exchange.Bitforex: return Bitforex.createBitforex(config, pair);
